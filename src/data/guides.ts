...
export const GUIDES: Guide[] = [
  {
    slug: 'can-you-ignore-private-parking-fine',
    title: 'Can You Ignore a Private Parking Fine?',
    description: 'The most common question about private parking charges. Learn what happens if you ignore them, when they can take you to court, and what your real options are.',
    category: 'rights',
    content: `## Can You Really Ignore a Private Parking Fine?
...
Ignoring a private parking charge is not illegal and will not result in a criminal record, points on your licence, or bailiffs at your door. However, it does carry a risk of County Court action from certain operators. The safest approach is to check whether the charge has procedural flaws and appeal on those grounds.`,
    faqs: [
      {
        question: 'Will I get a criminal record if I ignore a private parking fine?',
        answer: 'No. Private parking charges are a civil matter, not criminal. You cannot get a criminal record, points on your licence, or be arrested for not paying a private parking charge.'
      },
      {
        question: 'Can private parking companies send bailiffs?',
        answer: 'No. Private parking operators cannot send bailiffs unless they have first obtained a County Court Judgment (CCJ) against you and you have failed to pay. Even then, enforcement agents (not bailiffs) would only be involved after further court proceedings.'
      },
      {
        question: 'Will an unpaid private parking charge affect my credit score?',
        answer: 'Not directly. Debt collection agencies acting for parking companies cannot register the debt with credit reference agencies. However, if the operator obtains a CCJ against you and you do not pay within 30 days, the CCJ will appear on your credit file for 6 years.'
      },
      {
        question: 'What if I receive a letter from a debt collector?',
        answer: 'Debt collection letters are designed to pressure you into paying. The debt collector has no more legal power than the parking operator. They cannot visit your home, seize property, or affect your credit score. Many debt collectors are simply a trading name of the parking company itself.'
      },
      {
        question: 'How long can a private parking company chase me for?',
        answer: 'Under the Limitation Act 1980, the operator has 6 years from the date of the alleged contravention to bring a claim in the County Court. After 6 years, the claim becomes statute-barred. In Scotland, the equivalent period is 5 years under the Prescription and Limitation (Scotland) Act 1973.'
      },
      {
        question: 'Should I respond to the parking charge at all?',
        answer: 'It is generally better to appeal than to ignore. If you appeal and the operator rejects it, you can escalate to POPLA or IAS at no cost. Winning at appeal means the charge is cancelled. If you ignore it, the operator may escalate to debt collection or court action.'
      }
    ],
    relatedGuides: [
    ...
    seoTitle: 'Can You Ignore a Private Parking Fine? | What Really Happens (2024)',
    seoDescription: 'Find out what actually happens if you ignore a private parking fine. Covers court risks, debt collectors, credit scores, and the smart approach to private parking charges.'
  },
  {
    slug: 'how-to-appeal-council-parking-fine',
    title: 'How to Appeal a Council Parking Fine (PCN)',
    description: 'Step-by-step guide to challenging a council Penalty Charge Notice. Covers informal challenges, formal representations, and tribunal appeals.',
    category: 'process',
    content: `## How to Appeal a Council Parking Fine
...
1. Write to the council (or use their online portal) explaining why you believe the PCN was issued incorrectly
2. Include any evidence: photos of signage, pay-and-display tickets, medical evidence, etc.
3. The 14-day discount period is typically frozen while the informal challenge is considered
...
2. You never received the PCN (if it was served on the vehicle)
3. The PCN does not comply with legal requirements
4. You were not the owner at the time
5. The vehicle had been taken without consent
6. You are a hire company and have provided the hirer's details
7. The penalty exceeds the relevant amount
8. There has been a procedural error
...
1. The charge increases by 50% after the payment deadline
2. The council registers a debt at the Traffic Enforcement Centre (TEC)
3. You receive an order for recovery, adding further costs
4. Bailiffs (enforcement agents) can be instructed to collect the debt
5. Your vehicle can be clamped or removed
...
Unlike private parking charges, council PCNs have real enforcement teeth. Always respond, even if you intend to appeal.`,
    faqs: [
      {
        ...
        answer: 'You have 14 days for an informal challenge, 28 days from the Notice to Owner for formal representations, and 28 days from the rejection of representations to appeal to the tribunal. Missing these deadlines can limit your options.'
      },
      {
        question: 'Will I lose the 50% discount if I appeal?',
        answer: 'The 14-day discount period is typically paused during an informal challenge. If you make formal representations and they are rejected, you usually have 14 days to pay at the discounted rate. Check your rejection letter for the specific deadline.'
      },
      {
        question: 'Can I appeal a council parking fine online?',
        answer: 'Yes. Most councils accept informal challenges online. London Tribunals and the Traffic Penalty Tribunal both offer online appeal submission and evidence upload.'
      },
      {
        question: 'What is the success rate for parking fine appeals?',
        answer: 'At tribunal level, success rates are typically between 50% and 60%. At the informal challenge and formal representations stages, success rates vary widely by council but are generally lower. Having clear evidence and citing the correct legal grounds significantly improves your chances.'
      },
      {
        question: 'Can I appeal if I have already paid the fine?',
        answer: 'Paying the fine is generally treated as accepting liability. Once paid, it is very difficult to get a refund, even if you later discover grounds for appeal. If you intend to appeal, do not pay until the appeals process is exhausted.'
      },
      {
        question: 'What evidence should I include with my appeal?',
        answer: 'Photos of the location and signage (ideally timestamped), your parking ticket or payment receipt, any correspondence with the council, medical evidence if relevant, witness statements, and screenshots of parking app payments. The more evidence you provide, the stronger your appeal.'
      }
    ],
    relatedGuides: [
    ...
    seoTitle: 'How to Appeal a Council Parking Fine | Step-by-Step PCN Guide (2024)',
    seoDescription: 'Complete guide to appealing a council parking fine. Covers informal challenges, formal representations, tribunal appeals, deadlines, and common winning grounds.'
  },
  {
    slug: 'how-to-appeal-private-parking-fine',
    title: 'How to Appeal a Private Parking Fine',
    description: 'Complete guide to challenging a private parking charge. Covers operator appeals, POPLA, IAS, and your legal rights under contract law.',
    category: 'process',
    content: `## How to Appeal a Private Parking Fine
...
1. **Is the operator a member of BPA or IPC?** If not, they have no access to DVLA keeper data and limited enforcement options. Check the BPA and IPC websites for registered operators.
2. **Was the Notice to Keeper (NtK) served within the correct timeframe?** Under POFA 2012, the operator must serve the NtK within 14 days of the alleged contravention (or 14 days of obtaining keeper data from the DVLA if the charge was ANPR-based). Failure to comply with this requirement means keeper liability does not transfer.
3. **Is the charge amount reasonable?** The charge must be a genuine pre-estimate of the landowner's loss, not a penalty. Following the Supreme Court ruling in ParkingEye v Beavis (2015), charges up to around £100 are generally considered legitimate, but the specific circumstances matter.
...
1. Send further payment demands
2. Pass the debt to a collection agency
3. In rare cases, issue a County Court claim
...
1. **Take photos**: If possible, photograph the signage (or lack of it) at the site. Include wide shots showing sign placement and close-ups showing the text.
2. **Keep records**: Save all correspondence, payment receipts, and parking app screenshots.
3. **Be specific**: Reference the BPA or IPC Code of Practice, POFA 2012, and any relevant case law.
4. **Stay factual**: Emotional appeals are less effective than clear, evidence-based arguments.
5. **Meet deadlines**: Submit your appeal and escalation within the stated timeframes.`,
    faqs: [
      {
        question: 'How long do I have to appeal a private parking charge?',
        answer: 'You typically have 28 days from the date of the charge to appeal to the operator. If rejected, you usually have 28 days to escalate to POPLA or IAS. Check your specific notice for the exact deadlines.'
      },
      {
        question: 'Is there a fee to appeal to POPLA or IAS?',
        answer: 'No. Appeals to both POPLA and IAS are completely free for motorists. The parking operator pays the cost of the appeal.'
      },
      {
        question: 'What happens if I lose at POPLA or IAS?',
        answer: 'If you lose, the original charge remains due. However, the operator cannot increase the amount because you appealed. Most operators will send further payment demands but relatively few pursue court action.'
      },
      {
        question: 'Can I appeal if the charge has been passed to debt collectors?',
        answer: 'The formal appeal window may have closed, but you can still write to the operator or debt collector setting out why the charge is invalid. Debt collectors have no more legal power than the operator. If the charge has procedural flaws, these remain valid defences regardless of who is demanding payment.'
      },
      {
        question: 'Do I need a solicitor to appeal?',
        answer: 'No. The appeal processes at operator level, POPLA, and IAS are designed for individuals without legal representation. Clear evidence and correct legal references are more important than legal jargon.'
      }
    ],
    relatedGuides: [
    ...
    seoTitle: 'How to Appeal a Private Parking Fine | Free Step-by-Step Guide (2024)',
    seoDescription: 'Complete guide to appealing private parking charges. Covers operator appeals, POPLA, IAS, common winning grounds, and what to do if debt collectors get involved.'
  },
  {
    slug: 'pofa-2012-explained',
    title: 'Protection of Freedoms Act 2012: Keeper Liability Explained',
    description: 'Understanding how POFA 2012 changed private parking enforcement. Learn about keeper liability, the conditions operators must meet, and how to use POFA in your appeal.',
    category: 'legal',
    content: `## Protection of Freedoms Act 2012: What Every Driver Needs to Know
...
The Parking (Code of Practice) Act 2019 paved the way for a single government-backed Code of Practice to replace the separate BPA and IPC codes. The new code, expected to set a maximum charge level and standardise enforcement, will work alongside POFA. The core keeper liability provisions under POFA remain unchanged.`,
    faqs: [
      {
        ...
        answer: 'Under POFA 2012, the parking operator must serve a Notice to Keeper within 14 days of the vehicle leaving the land (or within 14 days of obtaining DVLA keeper data). If they miss this deadline, keeper liability does not transfer and the operator can only pursue the driver.'
      },
      {
        question: 'Does POFA apply in Scotland?',
        answer: 'No. POFA Schedule 4 only applies in England and Wales. Scotland has separate common law rules regarding keeper liability, and the legal position is less clear-cut.'
      },
      {
        question: 'What happens if I name the driver?',
        answer: 'If you provide the driver\'s name and address to the operator, your keeper liability is removed. The operator must then pursue the named driver instead. The details you provide must be genuine; providing false information could lead to complications.'
      },
      {
        question: 'Can the operator claim more than the original charge?',
        answer: 'Under POFA, the keeper\'s liability is limited to the amount of the original parking charge. The operator cannot add additional charges, interest, or debt collection fees to the amount recoverable under keeper liability.'
      },
      {
        question: 'What if the NtK has wrong information on it?',
        answer: 'If the NtK does not contain all the information required by POFA Schedule 4, it may be non-compliant. This is a strong ground for appeal, as non-compliance means keeper liability has not properly transferred. Check the NtK against the statutory requirements carefully.'
      }
    ],
    relatedGuides: [
      'notice-to-keeper-rules',
    ...
    seoTitle: 'POFA 2012 Explained | Keeper Liability for Private Parking Fines',
    seoDescription: 'Complete guide to the Protection of Freedoms Act 2012 and keeper liability. Learn the 14-day rule, NtK requirements, and how to use POFA to beat parking charges.'
  },
  {
    slug: 'notice-to-keeper-rules',
    title: 'Notice to Keeper (NtK) Rules: The 14-Day Rule Explained',
    description: 'Everything you need to know about the Notice to Keeper. Learn the 14-day deadline, required content, and how NtK failures can cancel your parking charge.',
    category: 'legal',
    content: `## Notice to Keeper: The Key to Many Successful Appeals
...
1. A statement of the amount of the parking charge
2. A statement of the grounds on which the charge is claimed (i.e., what the driver allegedly did wrong)
3. Details of how and where to pay
4. A statement that the charge must be paid before the end of 28 days beginning with the day after service
5. A statement that the keeper is not liable if they were not the driver AND they provide the driver's details
6. Information about the right to appeal to the operator and then to POPLA or IAS
7. The operator's accredited trade association membership details
8. Contact details for the operator
...
1. Note the date of the alleged contravention on the NtK
2. Note the date printed on the NtK as the date it was sent
3. Note the date you actually received it (if you can evidence this, e.g., from the postmark)
4. Count the days between the contravention and the date of posting
5. Check all required content is present
6. If anything is missing or the timing is wrong, you likely have grounds for appeal
...
- **Debt collection letters**: Not official documents; just payment demands from a third party`,
    faqs: [
      {
        question: 'What is the 14-day rule for the Notice to Keeper?',
        answer: 'The parking operator must serve the NtK on the registered keeper within 14 days. The start date depends on whether a windscreen notice was given (14 days from the vehicle leaving) or if it was ANPR-only (14 days from when the operator received DVLA data). If the NtK is late, keeper liability does not transfer.'
      },
      {
        question: 'How do I know if my NtK was served on time?',
        answer: 'Check the date of the alleged contravention, the date the NtK was sent (shown on the letter), and the date you received it. The NtK is deemed served on the second business day after posting. If more than 14 days have elapsed from the trigger event to the deemed date of service, it may be late.'
      },
      {
        question: 'What if the NtK was sent to a previous keeper?',
        answer: 'If you were not the registered keeper at the time of the alleged contravention, you are not liable. Write to the operator confirming you were not the keeper and provide evidence of when you disposed of the vehicle (e.g., V5C logbook, sale receipt).'
      },
      {
        question: 'Does the NtK have to come by recorded delivery?',
        answer: 'No. The NtK can be sent by ordinary first-class post. The operator does not need to prove you actually received it, only that it was sent within the required timeframe. However, if you can prove the NtK was not sent on the date claimed (e.g., by checking the postmark), this may support your appeal.'
      },
      {
        question: 'Can the operator issue a new NtK if the first one was wrong?',
        answer: 'The legislation does not explicitly prohibit a second NtK. However, many appeal adjudicators have ruled that the operator gets one chance to comply with the NtK requirements. If the first NtK was defective, issuing a replacement outside the 14-day window is unlikely to cure the non-compliance.'
      }
    ],
    relatedGuides: [
      'pofa-2012-explained',
    ...
    seoTitle: 'Notice to Keeper Rules | The 14-Day NtK Rule for Parking Fines',
    seoDescription: 'Complete guide to Notice to Keeper requirements. Learn the 14-day rule, what the NtK must contain, and how NtK failures can get your parking charge cancelled.'
  },
  {
    slug: 'parking-fine-signage-rules',
    title: 'Parking Fine Signage Rules: When Signs Are Not Good Enough',
    description: 'Learn when inadequate signage makes a parking charge invalid. Covers both council and private parking signage requirements.',
    category: 'legal',
    content: `## Parking Signage Rules: Your Rights When Signs Fail
...
1. **No sign at the entrance**: If there is no sign (or the sign is not visible) at the point where you enter the car park, you may not have been given adequate notice of the terms.

2. **Contradictory signs**: If signs at different locations within the car park show different terms, the contract is ambiguous and may be unenforceable.

3. **Obscured signs**: Signs hidden by trees, other vehicles, temporary structures, or damaged/faded beyond legibility are not adequate.

4. **Missing information**: If the sign does not include all required information (charge amount, how to pay, how to appeal), it may not comply with the relevant Code of Practice.

5. **Sign added after the event**: If the restriction was introduced or changed and the signs were not updated, the charge may be invalid. Councils must follow the legal process for changing TROs, including advertising the change.

### How to Evidence Signage Problems

If you plan to challenge a parking charge on signage grounds:

1. **Return to the site and take photos**: Photograph every entrance, the parking area from multiple angles, and close-ups of all signs. Include wide shots that show the sign in context (is it visible? obscured?).
2. **Use Google Street View**: If the signage has since been changed, historical Street View images may show what the signs looked like at the time of your charge.
3. **Timestamp everything**: Your phone camera will timestamp photos automatically. This proves when you took them.
4. **Note weather and lighting**: If you received the charge at night or in poor weather, note that the signs may not have been visible under those conditions.`,
    faqs: [
      {
        question: 'Can I appeal if the sign was blocked by another vehicle?',
        answer: 'Yes. If the sign was not visible because it was obscured by another vehicle, a temporary structure, or any other obstruction, this is a valid ground for appeal. Take photos showing the obstruction and the sign\'s position.'
      },
      {
        question: 'Do private car parks need signs at every entrance?',
        answer: 'Both the BPA and IPC Codes of Practice require signs to be clearly visible at every vehicle entrance to the car park. If any entrance lacks adequate signage, motorists entering via that entrance may not have been given notice of the terms.'
      },
      {
        question: 'What if the sign was too small to read from my car?',
        answer: 'The terms must be brought to your attention before you park. If the text is too small to read from a vehicle, the operator has not adequately communicated the terms. The BPA recommends minimum text sizes, and failure to meet these standards supports an appeal.'
      },
      {
        question: 'Can I use Google Street View as evidence?',
        answer: 'Yes. Google Street View can be excellent evidence, especially if it shows the state of signage at a time close to your alleged contravention. Include screenshots with the date shown in your appeal submission.'
      },
      {
        question: 'What if the council changed the parking rules but did not update the signs?',
        answer: 'Councils must follow a legal process to change parking restrictions, including updating signs and road markings. If the signs do not match the Traffic Regulation Order, the restriction may not be enforceable. You can request a copy of the TRO from the council to check.'
      }
    ],
    relatedGuides: [
    ...
    seoTitle: 'Parking Fine Signage Rules | When Bad Signs Mean Invalid Charges',
    seoDescription: 'Complete guide to parking signage rules. Learn when inadequate, missing, or obscured signs make a parking charge invalid and how to evidence signage problems.'
  },
  {
    slug: 'grace-period-rules',
    title: 'Parking Fine Grace Period Rules',
    description: 'Understanding the 10-minute grace period for parking. When it applies, when it does not, and how to use it in your appeal.',
    category: 'rights',
    content: `## Grace Period Rules: The 10-Minute Rule for Parking
...
### The Legal Grace Period (Council Parking)

The Deregulation Act 2015 (Section 76) introduced a mandatory 10-minute grace period for council on-street parking in England. This means:

- If you are parked in a paid parking bay and your time expires, the council must wait at least 10 minutes after expiry before issuing a PCN
- This applies to on-street parking bays where payment is required
- The grace period applies in England only (not Scotland, Wales, or Northern Ireland for council enforcement, though some Welsh councils apply it voluntarily)
- It applies to metered bays, pay-and-display bays, and bays controlled by vouchers or permits with a time limit

**Important limitations:**
- The grace period does NOT apply to yellow line restrictions
- It does NOT apply to loading restrictions
- It does NOT apply to disabled bay misuse
- It does NOT apply to bus lanes or box junctions
- It does NOT apply where no payment is required (e.g., free time-limited bays in some areas have a separate consideration)
...
2. **Reference the correct rule**: For council PCNs in England, cite Section 76 of the Deregulation Act 2015. For private charges, cite the relevant Code of Practice (BPA or IPC).

3. **Check the signage**: The grace period should be mentioned on the signage. If it is not, this may be an additional ground for appeal.

4. **Consider the observation period**: For council PCNs, civil enforcement officers (CEOs) must observe the vehicle for a period before issuing a PCN. Check the observation notes on the PCN; these are available through a subject access request or freedom of information request.
...
Both can work in your favour when appealing.`,
    faqs: [
      {
        question: 'Is there a legal 10-minute grace period for parking?',
        answer: 'Yes, for council on-street paid parking in England, there is a mandatory 10-minute grace period under the Deregulation Act 2015. For private parking, both the BPA and IPC Codes of Practice require grace periods, typically 10 minutes.'
      },
      {
        question: 'Does the grace period apply to yellow lines?',
        answer: 'No. The 10-minute grace period under the Deregulation Act 2015 does not apply to yellow line restrictions, loading restrictions, disabled bays, bus lanes, or box junctions.'
      },
      {
        question: 'Does the grace period apply in Scotland and Wales?',
        answer: 'The Deregulation Act 2015 grace period applies in England only. Scotland and Wales have separate arrangements. Some Welsh councils apply a grace period voluntarily, but it is not legally mandated.'
      },
      {
        question: 'What if I overstayed by 11 minutes?',
        answer: 'If you overstayed by 11 minutes, you are 1 minute outside the typical 10-minute grace period. However, you may still have grounds for appeal based on mitigating circumstances, signage issues, or other factors. The grace period is a minimum, and some operators apply longer periods.'
      },
      {
        question: 'Does the grace period apply when I first arrive at a car park?',
        answer: 'The BPA Code of Practice requires a consideration period when you first arrive, allowing time to read the signs and decide whether to park. This is separate from the end-of-stay grace period but can also be used in your appeal if you were charged shortly after arriving.'
      }
    ],
    relatedGuides: [
      'how-to-appeal-council-parking-fine',
    ...
    seoTitle: 'Parking Fine Grace Period Rules | The 10-Minute Rule Explained (2024)',
    seoDescription: 'Complete guide to parking grace periods. Learn about the 10-minute rule for council and private parking, when it applies, and how to use it to appeal your fine.'
  },
  {
...
- Appeals with photographic evidence have significantly higher success rates than those without`,
  ...
  },
  {
    ...
    title: 'Traffic Penalty Tribunal (TPT) Guide',
    description: 'How to appeal a council parking fine to the Traffic Penalty Tribunal. Covers eligibility, the online process, evidence tips, and success rates.',
    category: 'process',
    content: `## Traffic Penalty Tribunal: How to Appeal a Council Parking Fine
...
London Tribunals can be reached at londoncouncils.gov.uk/services/parking-services.`,
    faqs: [
      {
        question: 'Is the Traffic Penalty Tribunal free?',
        answer: 'Yes. There is no fee to appeal to the TPT. The service is funded by participating councils.'
      },
      {
        question: 'Can I attend the hearing in person?',
        answer: 'Yes. You can choose an e-decision (written evidence only), a telephone hearing, or a personal attendance hearing. Most cases are decided on written evidence, but you have the right to attend in person if you prefer.'
      },
      {
        question: 'What happens if I win at the TPT?',
        answer: 'The PCN is cancelled and you owe nothing. The council cannot pursue the charge further or issue a new PCN for the same contravention. If you already paid the PCN, the council must refund you.'
      },
      {
        question: 'Can the council appeal the TPT decision?',
        answer: 'The council cannot appeal a TPT decision in the normal sense. However, in very rare cases, a decision can be reviewed if there was a procedural error or new evidence emerges. For all practical purposes, the TPT decision is final.'
      },
      {
        question: 'Do I lose the 50% discount if I appeal to the TPT?',
        answer: 'If you made formal representations and they were rejected, the council\'s rejection letter should offer a further 14-day period to pay at the discounted rate. If you appeal to the TPT and lose, you usually have 28 days to pay at the full rate. Check the specific terms in your rejection letter.'
      }
    ],
    relatedGuides: [
      'how-to-appeal-council-parking-fine',
    ...
    seoTitle: 'Traffic Penalty Tribunal Guide | How to Win Your TPT Appeal (2024)',
    seoDescription: 'Complete guide to appealing council parking fines at the Traffic Penalty Tribunal. Covers e-decisions, evidence tips, success rates, and statutory grounds.'
  },
  {
    slug: 'parking-fine-court-defence',
    title: 'Parking Fine Court Defence: What to Do If Taken to Court',
    description: 'What happens when a parking company takes you to County Court. Covers the process, how to defend yourself, key case law, and what to expect.',
    category: 'legal',
    content: `## Parking Fine Court Defence: A Complete Guide
...
2. **File a defence, not just an acknowledgement**: An acknowledgement of service gives you 28 days to file your defence. A full defence is better filed promptly.

3. **Request documents from the operator**: You can request disclosure of the landowner contract, ANPR maintenance records, signage installation records, and DVLA request documentation.

4. **Attend the hearing**: Even in a small claims case, attending demonstrates that you take the matter seriously. Many operators do not send representatives to hearings, which can result in the claim being struck out.

5. **Prepare a court bundle**: Organise your evidence into a clear bundle with numbered pages. Include: the claim form, your defence, NtK analysis, signage photos, receipts, and any case law you rely on.

6. **Costs are limited**: On the Small Claims Track, the losing party generally does not have to pay the other side's legal costs (except the court fee). This limits your financial exposure.`,
    faqs: [
      {
        question: 'Will I get a CCJ if I lose?',
        answer: 'If the court finds against you and you pay the judgment within 30 days, no CCJ will be recorded on your credit file. If you do not pay within 30 days, the CCJ will appear on your credit file for 6 years, which can significantly impact your ability to get credit.'
      },
      {
        question: 'Do I need a solicitor for a small claims parking case?',
        answer: 'No. The Small Claims Track is designed for litigants in person (people representing themselves). The process is informal, and the judge will guide you through the hearing. Many motorists successfully defend parking claims without legal representation.'
      },
      {
        question: 'What are the costs if I lose?',
        answer: 'On the Small Claims Track, you would typically only have to pay the original charge amount plus the court fee (currently £35-£80 depending on the claim value). You would not normally have to pay the operator\'s legal costs.'
      },
      {
        question: 'Can I counterclaim against the parking company?',
        answer: 'In theory, you could counterclaim for losses caused by the operator\'s conduct (e.g., harassment, breach of data protection). However, counterclaims in parking cases are rare and the amounts recoverable are typically small. Focus on your defence rather than a counterclaim.'
      },
      {
        question: 'What if I cannot attend the hearing date?',
        answer: 'You can apply to the court to have the hearing date changed. Courts will generally accommodate reasonable requests for adjournment, especially if made promptly. You can also ask for the case to be decided on written evidence alone.'
      }
    ],
    relatedGuides: [
      'can-you-ignore-private-parking-fine',
    ...
    seoTitle: 'Parking Fine Court Defence | How to Fight a Parking Charge in Court',
    seoDescription: 'Complete guide to defending a private parking charge in County Court. Covers the N1 form, filing a defence, key case law, and what to expect at the hearing.'
  },
  {
    slug: 'parking-fine-deadlines',
    title: 'Parking Fine Deadlines: Every Date You Need to Know',
    description: 'All the critical deadlines for council PCNs and private parking charges. Miss a deadline and your options shrink significantly.',
    category: 'process',
    content: `## Every Parking Fine Deadline You Need to Know
...
**Missed the County Court response deadline**: Apply immediately to have the default judgment set aside. You will need to show you have a real prospect of defending the claim and that you acted promptly once you became aware of the judgment.`,
    faqs: [
      {
        ...
        answer: 'If you miss the 14-day discount period for a council PCN, you will need to pay the full amount if you choose to pay. However, you can still appeal through formal representations and the tribunal. If you win at any stage, the PCN is cancelled entirely.'
      },
      {
        question: 'Can I get a deadline extended?',
        answer: 'In some cases, yes. Tribunals can accept late appeals in exceptional circumstances (illness, being abroad, not receiving the notice). The council may also accept late formal representations if you have a good reason for the delay.'
      },
      {
        question: 'When does a parking charge become statute-barred?',
        answer: 'Under the Limitation Act 1980, a parking operator has 6 years from the date of the alleged contravention to file a County Court claim. After 6 years (5 in Scotland), the claim is time-barred and cannot be pursued through the courts.'
      },
      {
        question: 'Does making an appeal pause the deadline clock?',
        answer: 'For council PCNs, making an informal challenge typically pauses the 14-day discount clock. Making formal representations pauses the enforcement clock until the council responds. For private charges, appealing to the operator and to POPLA/IAS pauses the charge escalation process.'
      },
      {
        question: 'What is the fastest way to resolve a parking fine?',
        answer: 'The fastest resolution is to pay within the 14-day discount period. If you believe the charge is invalid, the fastest appeal route is an informal challenge to the council (usually decided within 2-4 weeks) or a direct appeal to a private operator (usually 2-4 weeks).'
      }
    ],
    relatedGuides: [
      'how-to-appeal-council-parking-fine',
    ...
    seoTitle: 'Parking Fine Deadlines | Every Date You Need to Know (2024)',
    seoDescription: 'Complete list of parking fine deadlines. Covers council PCN discount periods, appeal windows, NtK timeframes, tribunal deadlines, and court limitation periods.'
  },
  {
    slug: 'blue-badge-parking-fines',
    title: 'Blue Badge Parking Fines: Rights for Disabled Drivers',
    description: 'Your rights when you receive a parking fine with a Blue Badge. Covers council and private parking, common issues, and how to appeal.',
    category: 'rights',
    content: `## Blue Badge Parking Fines: Know Your Rights
...
- Reference the duty to make reasonable adjustments for disabled people`,
    faqs: [
      {
        ...
        answer: 'Yes, in England you can park on double yellow lines for up to 3 hours with a valid Blue Badge, provided there is no loading restriction in force (shown by kerb markings or signs) and you are not causing an obstruction. You must display both the badge and a time clock.'
      },
      {
        question: 'Do private car parks have to honour Blue Badges?',
        answer: 'No. Private car parks are not legally required to honour Blue Badges. However, many do offer disabled parking provisions. Always check the signage at the specific car park. Under the Equality Act 2010, service providers must make reasonable adjustments for disabled people, which could include parking concessions.'
      },
      {
        question: 'What if my Blue Badge fell off the dashboard?',
        answer: 'This is one of the most common Blue Badge parking fine situations. Many councils accept this as a mitigating circumstance if you can prove you hold a valid badge. Include a photo of your badge, explain what happened, and provide the badge number in your appeal.'
      },
      {
        question: 'Can someone else use my Blue Badge?',
        answer: 'The Blue Badge can only be used when the badge holder is being transported in the vehicle or is being picked up/dropped off. Someone else can drive the vehicle and use the badge only if the badge holder is a passenger. Using the badge when the holder is not involved is a criminal offence.'
      },
      {
        question: 'My disability means I need more time. Is this a valid appeal ground?',
        answer: 'Yes. Under the Equality Act 2010, both councils and private operators should make reasonable adjustments for disabled people. If your disability meant you needed extra time (e.g., slower walking speed, medical appointment overrun), this is a valid ground for appeal. Include medical evidence if available.'
      }
    ],
    relatedGuides: [
      'how-to-appeal-council-parking-fine',
    ...
    seoTitle: 'Blue Badge Parking Fines | Rights for Disabled Drivers (2024)',
    seoDescription: 'Complete guide to Blue Badge parking rights. Learn where you can park, what to do if you get a fine, and how to appeal council and private parking charges.'
  },
  {
    slug: 'new-parking-code-of-practice-2024',
    title: 'The New Parking Code of Practice: What It Means for Drivers',
    description: 'Understanding the new government-backed Parking Code of Practice. Covers maximum charges, new rules, and how it affects your rights.',
    category: 'legal',
    content: `## The New Parking Code of Practice: What You Need to Know
...
1. The existing BPA or IPC Code of Practice still applies (depending on the operator's membership)
2. POFA 2012 requirements remain in full force
3. Your existing appeal rights (POPLA or IAS) are unchanged
4. The maximum charge caps under the new code are NOT yet in force
...
- Greater transparency about charges and enforcement practices`,
    faqs: [
      {
        question: 'Is the new Parking Code of Practice in force yet?',
        answer: 'As of 2024, the new code is not yet fully in force. It has faced multiple delays since the Parking (Code of Practice) Act 2019 was passed. The existing BPA and IPC codes continue to apply until the new code is implemented.'
      },
      {
        question: 'Will the new code reduce parking charges?',
        answer: 'Yes. The new code proposes maximum charge levels that would significantly reduce what many operators currently charge. The exact caps are still being finalised, but they are expected to be lower than the typical £60-100 charges currently issued.'
      },
      {
        question: 'Will there still be two appeals services (POPLA and IAS)?',
        answer: 'Under the new code, a single independent appeals service will replace both POPLA and IAS. This will simplify the process for motorists, who currently need to know which trade body their operator belongs to in order to identify the correct appeals service.'
      },
      {
        question: 'Does the new code affect council parking fines?',
        answer: 'No. The new code only applies to private parking operators. Council PCNs are governed by separate legislation (Traffic Management Act 2004 and related regulations). Council parking enforcement is unaffected by the new code.'
      },
      {
        question: 'Can I reference the new code in my appeal even though it is not in force?',
        answer: 'You can reference the government\'s proposed standards as evidence of what is considered fair and proportionate. While not binding, adjudicators may find it persuasive, particularly on issues like charge levels and grace periods.'
      }
    ],
    relatedGuides: [
      'pofa-2012-explained',
    ...
    seoTitle: 'New Parking Code of Practice 2024 | What It Means for Drivers',
    seoDescription: 'Complete guide to the new government-backed Parking Code of Practice. Covers maximum charges, new rules, grace periods, and how it affects your parking rights.'
  },
  {
    slug: 'anpr-parking-fine-errors',
    title: 'ANPR Parking Fine Errors: When Cameras Get It Wrong',
    description: 'How to challenge parking charges based on ANPR camera evidence. Covers common errors, how to request evidence, and winning appeal arguments.',
    category: 'situation',
    content: `## ANPR Parking Fine Errors: Challenging Camera Evidence
...
### The Legal Standard for ANPR Evidence

Private parking operators must prove their claim on the "balance of probabilities" (more likely than not). ANPR evidence alone may not meet this standard if:

- The images are unclear or do not show your vehicle
- There is no corroborating evidence
- You provide counter-evidence showing different times
- The system has known reliability issues

At POPLA and IAS, adjudicators have repeatedly held that unclear ANPR images are insufficient to prove a contravention.
...
- If they are not complying with data protection law, this can support your appeal and may be grounds for a complaint to the Information Commissioner's Office (ICO)`,
    faqs: [
      {
        question: 'How do I get the ANPR photos of my vehicle?',
        answer: 'Make a Subject Access Request (SAR) under the Data Protection Act 2018 to the parking operator. Request all personal data they hold, including ANPR images. They must respond within 30 days. The request is free.'
      },
      {
        question: 'What if the ANPR misread my number plate?',
        answer: 'If the ANPR system misread your plate and the charge was sent to you in error, provide evidence of your actual vehicle registration (V5C logbook photo, vehicle insurance document) and request the images. If the plate in the image does not match your vehicle, the charge should be cancelled.'
      },
      {
        question: 'Can ANPR evidence alone prove a parking contravention?',
        answer: 'ANPR evidence can prove a contravention, but only if the images are clear, the timestamps are accurate, and the system is properly maintained. If any of these elements are questionable, the evidence may be insufficient on the balance of probabilities.'
      },
      {
        question: 'What if the camera clock was wrong?',
        answer: 'If you can demonstrate that the ANPR camera clock was inaccurate (e.g., by providing receipts with different timestamps, dashcam footage, or parking app records), this undermines the operator\'s evidence of overstay. Request the camera calibration records via a SAR.'
      },
      {
        question: 'Are parking operators required to tell me ANPR is in use?',
        answer: 'Yes. Under data protection law and the BPA/IPC Codes of Practice, operators must display clear signage informing motorists that ANPR cameras are in operation. Failure to do so may breach data protection regulations and the relevant Code of Practice.'
      }
    ],
    relatedGuides: [
      'how-to-appeal-private-parking-fine',
    ...
    seoTitle: 'ANPR Parking Fine Errors | How to Challenge Camera Evidence (2024)',
    seoDescription: 'Complete guide to challenging ANPR parking charges. Covers common camera errors, how to request evidence, data protection rights, and winning appeal arguments.'
  },
  {
    slug: 'parking-fine-payment-machine-broken',
    title: 'Parking Fine When the Payment Machine Was Broken',
    description: 'What to do if you got a parking fine because the payment machine was broken. Covers your rights, evidence tips, and how to appeal successfully.',
    category: 'situation',
    content: `## Parking Fine When the Payment Machine Was Broken
...
- You can request machine fault logs and maintenance records through a Freedom of Information request`,
    faqs: [
      {
        question: 'Can I park for free if the machine is broken?',
        answer: 'There is no automatic right to free parking if the machine is broken. However, if you attempted to pay and could not because the only payment method was unavailable, you have a strong defence against any charge. You should still park within the bay and for a reasonable time.'
      },
      {
        question: 'What if I did not take photos of the broken machine?',
        answer: 'While photos are the strongest evidence, you can still appeal without them. Request the council\'s or operator\'s machine fault logs for that date and time. Check social media for other reports. You can also return to the site to check for evidence of the fault. Your account of events, combined with the absence of a payment record, can still be persuasive.'
      },
      {
        question: 'Should I have used the pay-by-phone option instead?',
        answer: 'If a pay-by-phone option was clearly displayed and available, the council or operator may argue you should have used it. However, if the phone number was not visible, the phone system was also down, or you did not have a suitable phone, these are valid mitigating factors in your appeal.'
      },
      {
        question: 'Can I request the council\'s machine fault logs?',
        answer: 'Yes. You can request machine fault logs, maintenance records, and repair logs under the Freedom of Information Act 2000 (for councils) or via a Subject Access Request (for private operators). These records can confirm the machine was faulty at the time of your charge.'
      },
      {
        question: 'What if the machine was broken but I did not try to use it?',
        answer: 'If you did not attempt to use the machine (e.g., you assumed it was broken because of its appearance but did not actually try), your appeal is weaker. The strongest appeals are where the motorist can demonstrate they attempted to pay and were unable to. However, if there was a visible "out of order" sign, this shows the machine was known to be faulty.'
      }
    ],
    relatedGuides: [
      'how-to-appeal-council-parking-fine',
...
5. **Make admin fees transparent** and proportionate`,
  ...
  {
    slug: 'how-long-does-parking-appeal-take',
    title: 'How Long Does a Parking Appeal Take?',
    description: 'A clear timeline for every stage of the parking appeal process, from the initial operator appeal through to POPLA, IAS, TPT, and London Tribunals.',
    category: 'process',
    content: `## How Long Does a Parking Appeal Take?
...
Feeling unsure about your appeal timeline? [Start your appeal with our free tool](/appeal) and we will guide you through each step, including when to chase up.`,
    faqs: [
      {
        question: 'What happens if the parking operator does not respond to my appeal?',
        answer: 'Under the BPA and IPC codes of practice, operators must respond to appeals within a set timeframe. If the operator fails to respond within 56 days of receiving your appeal, the charge is deemed cancelled. Keep proof of when you sent your appeal.'
      },
      {
        question: 'Can the operator send debt collectors while my appeal is pending?',
        answer: 'No. Both the BPA and IPC codes require operators to pause all enforcement activity while an appeal is being processed. If you receive debt collection letters during an active appeal, report the operator to their trade body.'
      },
      {
        question: 'How long does a POPLA decision take?',
        answer: 'POPLA aims to issue decisions within 27 working days of receiving all evidence from both parties. In practice, straightforward cases may be decided in 2 to 3 weeks, while complex cases with multiple evidence submissions can take 6 to 8 weeks.'
      },
      {
        question: 'Does the 14-day discount period pause while I appeal a council PCN?',
        answer: 'If you make an informal challenge within the 14-day discount period, most councils will hold the discount open until they respond. However, this is not guaranteed by all councils. If your informal challenge is rejected, many councils give you a further 14 days at the discounted rate.'
      }
    ],
    relatedGuides: [
      'popla-appeal-guide',
    ...
    seoTitle: 'How Long Does a Parking Appeal Take? | Full Timeline (2026)',
    seoDescription: 'Find out how long parking appeals take at every stage: operator, POPLA, IAS, TPT, and London Tribunals. Includes typical timelines and what to do if they miss a deadline.'
  },
  {
    slug: 'how-long-can-you-be-chased-for-parking-fine',
    title: 'How Long Can They Chase You for a Parking Fine?',
    description: 'Understand the limitation periods for parking fines in England, Wales, and Scotland. Learn when the clock starts, what resets it, and when a charge becomes unenforceable.',
    category: 'rights',
    content: `## How Long Can They Chase You for a Parking Fine?
...
1. **Never admit liability in writing.** If you correspond with the operator, dispute the charge rather than acknowledging it.
2. **Never make a partial payment.** Either pay in full or dispute the charge. A partial payment can reset the limitation clock.
3. **Keep records.** Note the date of the alleged contravention so you can track when the limitation period expires.
4. **If you receive a court claim form after 6 years (or 5 in Scotland),** file a defence raising the limitation period. The claim should be struck out.
...
Not sure how old your charge is, or whether the limitation period applies? [Use our free appeal tool](/appeal) to check your options and get tailored advice.`,
    faqs: [
      {
        question: 'Does the 6-year limitation period apply to council parking fines?',
        answer: 'Council PCNs follow a separate enforcement process with their own deadlines. The council must serve a charge certificate, then register the debt at the Traffic Enforcement Centre. In practice, if a council has not progressed through these stages within about 2 years, it is very unlikely they will pursue the matter. The 6-year limitation period under the Limitation Act 1980 applies specifically to civil claims, which is the mechanism private operators use.'
      },
      {
        question: 'Can a debt collector restart the limitation period?',
        answer: 'No. A debt collector contacting you does not restart or extend the limitation period. Only a written acknowledgment of the debt by you, a part-payment, or the filing of a court claim can affect the limitation period. Debt collection letters, phone calls, and threats have no legal effect on the clock.'
      },
      {
        question: 'What if I moved and never received the original charge?',
        answer: 'The limitation period runs from the date of the alleged contravention regardless of whether you received the charge notice. However, if you never received a Notice to Keeper (NtK) because you had moved, this is a strong defence in itself, as the operator cannot establish keeper liability under POFA 2012 without properly serving the NtK.'
      },
      {
        question: 'Is the limitation period different for NHS hospital parking charges?',
        answer: 'No. NHS hospital car parks managed by private operators follow the same 6-year limitation period as any other private parking charge. The identity of the landowner does not affect the limitation rules.'
      }
    ],
    relatedGuides: [
      'parking-fine-statute-of-limitations',
    ...
    seoTitle: 'How Long Can They Chase You for a Parking Fine? | Limitation Periods (2026)',
    seoDescription: 'Learn the legal time limits for parking fine enforcement in England, Wales, and Scotland. Covers the 6-year and 5-year limitation periods, what resets the clock, and when charges become unenforceable.'
  },
  {
    slug: 'parking-fine-cap-2026',
    title: 'Parking Fine Cap UK 2026',
    description: 'Everything you need to know about the new parking fine caps introduced under the Parking Code of Practice. Which fines are affected, the new maximum amounts, and the implementation timeline.',
    category: 'legal',
    content: `## Parking Fine Cap UK 2026
...
Key milestones:
1. **Code published**: The single Code of Practice has been finalised.
2. **Single appeals service**: A new unified appeals service will replace POPLA and IAS.
3. **Transition period**: Operators have a set period to become compliant.
4. **Full enforcement**: After the transition, any operator charging above the caps risks losing their ability to access DVLA keeper data, which would effectively end their ability to enforce.
...
Want to check whether your parking fine exceeds the new caps? [Use our free appeal assessment tool](/appeal) to get an instant analysis of your charge.`,
    faqs: [
      {
        question: 'Do the new parking fine caps apply to council parking fines?',
        answer: 'No. The caps under the new Code of Practice apply only to charges issued by private parking operators. Council PCN amounts are set by separate legislation and remain at their current levels (£70 outside London, up to £130 in London for higher contraventions).'
      },
      {
        question: 'What happens if an operator charges more than the cap?',
        answer: 'If the caps are in force and an operator issues a charge above the permitted maximum, the charge is not compliant with the Code of Practice. You can challenge it on this basis. Operators who persistently breach the Code risk losing access to DVLA keeper data, which would prevent them from identifying registered keepers.'
      },
      {
        question: 'Do the caps apply to charges I received before the Code came into force?',
        answer: 'The caps apply to contraventions that occur after the Code comes into force. Charges issued for earlier contraventions are governed by the rules that applied at the time. However, you can still use the new cap amounts as evidence when arguing that an older charge was disproportionate.'
      },
      {
        question: 'Will the new Code affect my existing appeal?',
        answer: 'If your contravention occurred before the Code came into force, the old rules apply. However, assessors at POPLA and IAS may take the new caps into account when considering proportionality arguments. It is worth mentioning the caps in your appeal if the charge exceeds the new maximums.'
      }
    ],
    relatedGuides: [
      'new-parking-code-of-practice-2024',
    ...
    seoTitle: 'Parking Fine Cap UK 2026 | New Maximum Charges Explained',
    seoDescription: 'The new UK parking fine caps limit private charges to £50 or £100. Learn which fines are affected, the implementation timeline, and how to use the caps in your appeal.'
  },
  {
    slug: 'parking-fine-during-roadworks',
    title: 'Parking Fine During Roadworks',
    description: 'Got a parking fine while roadworks were in place? Learn about temporary restrictions, TRO requirements, unclear signage defences, and how to challenge these charges.',
    category: 'situation',
    content: `## Parking Fine During Roadworks
...
Received a parking fine during roadworks? [Start your free appeal](/appeal) and we will help you identify the strongest grounds based on your situation.`,
    faqs: [
      {
        question: 'Can I get a parking fine for parking where roadworks removed the parking spaces?',
        answer: 'If roadworks physically removed the available parking but alternative arrangements were not clearly signposted, you have grounds for appeal. The council must provide clear signage directing motorists to alternative parking. Without this, enforcement is unreasonable.'
      },
      {
        question: 'How do I find out if there was a valid TTRO?',
        answer: 'Submit a Freedom of Information request to the local council asking for the TTRO or Temporary Traffic Notice covering the specific location and dates. Councils must respond within 20 working days. If no TTRO exists, the temporary restriction was not enforceable.'
      },
      {
        question: 'What if the roadworks were finished but the signs were still up?',
        answer: 'If roadworks have been completed but temporary restriction signs have not been removed, the situation creates ambiguity. You can argue that the signs were misleading and that you reasonably believed the temporary restrictions still applied (or, if you parked in a "permanently" restricted area that was covered by temporary signs, that the permanent signs were still obscured).'
      },
      {
        question: 'Do utility companies have to set up parking restriction signs?',
        answer: 'Yes. When utility companies (gas, water, electric, telecoms) carry out works that affect parking, they must obtain the appropriate notices and erect compliant signage. They are held to the same standards as the council in terms of signage requirements.'
      }
    ],
    relatedGuides: [
      'parking-fine-no-signs',
    ...
    seoTitle: 'Parking Fine During Roadworks | How to Appeal (2026)',
    seoDescription: 'Challenge a parking fine issued during roadworks. Covers TTRO requirements, signage failures, temporary restrictions, and step-by-step appeal advice.'
  },
  {
    slug: 'parking-fine-foreign-vehicle',
    title: 'Parking Fine on a Foreign Vehicle',
    description: 'Received a parking fine on a foreign-registered vehicle? Learn whether operators and councils can enforce, their DVLA access limitations, and your rights under POFA 2012.',
    category: 'situation',
    content: `## Parking Fine on a Foreign Vehicle
...
1. **Private charge on a foreign vehicle**: If you did not identify yourself as the driver and the operator cannot trace you through the DVLA, enforcement is very unlikely.
2. **Council PCN**: If the PCN was affixed to the vehicle and you were not identified, enforcement is difficult but not impossible. The council may use other methods to trace you.
3. **Rental vehicles**: Expect the charge to follow you via the rental company.
4. **Do not ignore a court claim**: If you do receive a County Court claim form (unlikely for foreign vehicles), you must respond regardless of your vehicle's registration.

Received a parking charge on a foreign vehicle? [Check your options with our free appeal tool](/appeal) to see whether enforcement is possible in your case.`,
    faqs: [
      {
        question: 'Can a private parking company fine a car with EU plates?',
        answer: 'They can issue a charge notice on the windscreen, but they cannot obtain keeper details from the DVLA for foreign vehicles. Without keeper details, they cannot establish keeper liability under POFA 2012 or pursue the registered keeper. They would need to identify the driver directly.'
      },
      {
        question: 'Will a UK parking fine follow me back to my home country?',
        answer: 'In practice, no. There is no routine cross-border enforcement mechanism for parking fines between the UK and other countries. Private operators have no means to trace foreign keepers, and council PCNs are rarely pursued internationally.'
      },
      {
        question: 'Can a rental company charge me for a parking fine on a foreign rental car?',
        answer: 'Yes. Most rental agreements include a clause allowing the company to charge parking fines to your card. They may also add an administration fee. Check your rental agreement for the specific terms. The rental company can provide your details to the parking operator.'
      },
      {
        question: 'What if I am a UK resident driving a foreign-registered car?',
        answer: 'If you have been resident in the UK for more than 6 months, you are legally required to register the vehicle with the DVLA. While a parking operator may not be able to trace you through the DVLA, driving an unregistered foreign vehicle is a separate offence that could result in fines, seizure of the vehicle, or prosecution.'
      }
    ],
    relatedGuides: [
      'parking-fine-rental-car',
    ...
    seoTitle: 'Parking Fine on a Foreign Vehicle UK | Can They Enforce? (2026)',
    seoDescription: 'Find out if UK parking operators and councils can enforce fines on foreign-registered vehicles. Covers DVLA access, POFA 2012 limitations, rental cars, and enforcement realities.'
  },
  {
    slug: 'parking-fine-pregnancy',
    title: 'Parking Fine When Pregnant',
    description: 'Received a parking fine while pregnant? Learn how to use medical grounds and mitigating circumstances in your appeal, what evidence you need, and your chances of success.',
    category: 'situation',
    content: `## Parking Fine When Pregnant
...
1. **Medical evidence**: A letter from your midwife, GP, or hospital confirming the appointment or medical event. Include the date, time, and nature of the visit.
2. **Maternity notes**: Your hand-held maternity notes can corroborate appointment times.
3. **Hospital records**: If the overstay was caused by an appointment overrun, request a record showing your appointment time and the time you were seen or discharged.
4. **Photographs**: If mobility was an issue, photos showing the distance between available parking and your destination can help.
...
Received a parking fine related to your pregnancy? [Start your free appeal](/appeal) and we will help you build a strong mitigating circumstances case.`,
    faqs: [
      {
        question: 'Is pregnancy a valid reason to appeal a parking fine?',
        answer: 'Yes, but it must be directly connected to the reason for the contravention. Simply being pregnant is not enough. You need to show that a pregnancy-related medical appointment, illness, or emergency prevented you from complying with the parking restriction.'
      },
      {
        question: 'Do I need a letter from my doctor or midwife?',
        answer: 'Medical evidence significantly strengthens your appeal. A brief letter from your midwife, GP, or hospital confirming the appointment, its scheduled and actual times, and any pregnancy-related complications is the most persuasive evidence you can provide.'
      },
      {
        question: 'Can I appeal a hospital parking fine if my scan appointment ran late?',
        answer: 'Yes, this is one of the strongest grounds for appeal. Hospital appointments frequently overrun, and patients cannot simply leave a medical examination. Request confirmation from the hospital of your appointment time and actual discharge time, and include this with your appeal.'
      },
      {
        question: 'Does the 10-minute grace period help if I was only slightly over?',
        answer: 'The Parking (Code of Practice) Act requires private operators to allow a 10-minute grace period after a paid-for period expires. If you overstayed by less than 10 minutes, you have a strong defence regardless of pregnancy. Check whether the grace period was applied before using mitigating circumstances as your primary ground.'
      }
    ],
    relatedGuides: [
      'parking-fine-payment-machine-broken',
    ...
    seoTitle: 'Parking Fine When Pregnant | Medical Grounds Appeal Guide (2026)',
    seoDescription: 'Appeal a parking fine on pregnancy grounds. Learn what evidence you need, how to frame mitigating circumstances, and your chances of success with medical evidence.'
  },
  {
    slug: 'parking-fine-funeral',
    title: 'Parking Fine While Attending a Funeral',
    description: 'Received a parking fine while attending a funeral? Learn how compelling circumstances apply, what evidence to provide, and how to write a successful appeal.',
    category: 'situation',
    content: `## Parking Fine While Attending a Funeral

Few situations are more distressing than receiving a parking fine while attending a funeral. Whether you overstayed, parked on a restriction you did not notice, or could not find a suitable space near the venue, funeral attendance is widely recognised as a compelling circumstance in parking appeals.

### Why Funerals Are Recognised as Compelling Circumstances

Both council PCN appeals and private parking charge challenges recognise that funerals involve unique pressures:

- **Emotional distress** that affects your ability to notice signage or track time.
- **Unpredictable timing**, as funeral services can run longer than scheduled.
- **Limited parking** near churches, crematoriums, and cemeteries, which are often in residential areas with parking restrictions.
- **Cortege requirements**, where mourners may need to park in specific locations to join the procession.

The Traffic Penalty Tribunal and London Tribunals have both upheld appeals where the motorist was attending a funeral and could demonstrate they acted reasonably in the circumstances.

### What Evidence You Need

1. **Funeral order of service**: This confirms the date, time, and location.
2. **Death certificate or notice**: Establishes the bereavement.
3. **Your relationship to the deceased**: A brief explanation helps the adjudicator understand the circumstances.
4. **Timing evidence**: If the service overran, get confirmation from the funeral director.
5. **Photographs of parking**: If the area was clearly overwhelmed with funeral attendees' vehicles, photos showing limited availability help.

### How to Write Your Appeal

Be concise, dignified, and factual:

- Explain that you were attending a funeral at the specific location on the date and time in question.
- Describe why you parked where you did (limited alternatives, procession requirements, proximity to the venue).
- If the service overran, state this and provide supporting evidence.
- Attach the order of service, timing evidence, and any other supporting documents.
- Request that the charge be cancelled in light of the compelling circumstances.

### Success Rates

Funeral-related appeals have strong success rates across all appeal bodies. Key factors that increase your chances:

- Clear evidence linking you to the funeral (order of service, your name in the programme).
- Reasonable behaviour (you parked as close to lawfully as possible given the circumstances).
- Prompt appeal submission.

Appeals may be weaker if you parked very far from the venue (suggesting the funeral was not the reason for that specific parking location) or if you remained parked for a long time after the service ended without explanation.

### Practical Tips

- If you are organising a funeral, ask the funeral director about parking arrangements and whether the council can temporarily relax restrictions near the venue.
- Some councils will issue temporary parking dispensations for funerals. Contact the council's parking team in advance.
- If you see an enforcement officer while at a funeral, explain the situation calmly. Many officers use discretion in these circumstances.

Received a parking fine while at a funeral? [Start your free appeal](/appeal) and we will help you present the strongest possible case.`,
    faqs: [
      {
        question: 'Is attending a funeral a valid reason to appeal a parking fine?',
        answer: 'Yes. Funeral attendance is widely recognised as a compelling circumstance by both council tribunals and private parking appeals bodies. You will need evidence such as the order of service, timing details, and an explanation of why you had to park where you did.'
      },
      {
        question: 'Can I get a parking dispensation from the council for a funeral?',
        answer: 'Some councils offer temporary parking dispensations for funeral services. Contact the council parking team in advance and provide details of the funeral, expected number of vehicles, and the area where parking will be needed. Not all councils offer this, but it is worth asking.'
      },
      {
        question: 'What if I was not a close relative of the deceased?',
        answer: 'You do not need to be a close relative. Any genuine mourner attending the funeral has grounds to cite compelling circumstances. Provide the order of service and your attendance as evidence. The appeal body will consider whether your attendance was genuine and whether you acted reasonably.'
      },
      {
        question: 'What if there was a car park nearby that I could have used?',
        answer: 'This can weaken your appeal, but it does not automatically defeat it. If the car park was full, too far given the circumstances, or you were not aware of it due to the emotional situation, explain this. The key is demonstrating that you acted reasonably in a difficult moment.'
      }
    ],
    relatedGuides: [
      'how-to-appeal-council-parking-fine',
    ...
    seoTitle: 'Parking Fine While at a Funeral | Compelling Circumstances Appeal (2026)',
    seoDescription: 'Appeal a parking fine received while attending a funeral. Covers compelling circumstances, evidence needed, how to write your appeal, and success rates.'
  },
  {
    slug: 'parking-fine-electric-vehicle-charging',
    title: 'Parking Fine While Charging Electric Vehicle',
    description: 'Got a parking fine at an EV charging bay? Learn about charging bay rules, overstay while charging, broken charger defences, and how to appeal.',
    category: 'situation',
    content: `## Parking Fine While Charging an Electric Vehicle
...
1. **Overstaying while charging**: Many bays have a maximum stay (often 1 to 4 hours). If your charge takes longer than the allowed period, you may receive a fine even though you were actively charging.
2. **Remaining parked after charging completes**: This is the most common issue. Once your vehicle reaches full charge (or your session ends), you are expected to move it. Some bays have a grace period; many do not.
3. **Parking without charging**: Using an EV bay without plugging in, or plugging in without starting a charging session, can result in a fine.
4. **Non-EV in a charging bay**: ICE vehicles (internal combustion engine) parked in designated EV bays are almost always fined.
...
Got a fine at a charging bay? [Use our free appeal tool](/appeal) to check your grounds and generate a tailored appeal letter.`,
    faqs: [
      {
        question: 'Can I get fined for parking at an EV charger while my car is still charging?',
        answer: 'Yes, if the bay has a maximum stay period and you exceed it. Even if your vehicle is still actively charging, the time limit applies. Check the signage for the maximum stay. Some locations are more lenient than others, particularly if the charger is slower than advertised.'
      },
      {
        question: 'What if the EV charger was broken when I arrived?',
        answer: 'A broken charger is a strong defence. Gather evidence: screenshots from the charging app showing the fault, photographs of error messages on the charger, and any confirmation from the charging network. If you parked intending to charge and could not due to a fault, you should not be penalised.'
      },
      {
        question: 'Can a non-electric car be fined for parking in an EV charging bay?',
        answer: 'Yes. Most EV charging bays are restricted to electric vehicles that are actively charging. An ICE vehicle parked in a charging bay can be issued a PCN (council) or parking charge (private). Some councils issue PCNs under contravention code 27 (parked in a special enforcement area).'
      },
      {
        question: 'Is there a grace period after charging finishes?',
        answer: 'This depends on the specific bay and operator. Some locations allow a short grace period (5 to 15 minutes) after a charging session ends. Others start enforcement immediately. Check the signage and the terms of the charging network. The 10-minute grace period under the new Parking Code of Practice may apply to private charging bays.'
      }
    ],
    relatedGuides: [
      'parking-fine-signage-rules',
    ...
    seoTitle: 'Parking Fine While Charging EV | EV Charging Bay Rules (2026)',
    seoDescription: 'Appeal a parking fine at an EV charging bay. Covers overstay rules, broken charger defences, signage requirements, and how to challenge council and private charges.'
  },
  {
    slug: 'parking-fine-school-pickup',
    title: 'Parking Fine at School Pickup',
    description: 'Got a parking fine at school drop-off or pickup? Learn about school zig-zag lines, council enforcement, common defences, and how to appeal.',
    category: 'situation',
    content: `## Parking Fine at School Pickup
...
Received a school parking fine? [Start your free appeal](/appeal) and we will assess whether you have valid grounds for challenge.`,
    faqs: [
      {
        question: 'Can I stop on school zig-zag lines to drop off my child?',
        answer: 'No, not during the restricted hours shown on the nearby signs. The restriction prohibits stopping for any purpose, including dropping off or picking up children. The only exception is a genuine emergency. Outside the restricted hours, the markings are advisory only.'
      },
      {
        question: 'Can the council use CCTV to issue parking fines at schools?',
        answer: 'Yes. Councils have the legal power to use approved CCTV cameras to enforce school keep clear restrictions. The CCTV evidence must clearly show your vehicle stopped on the markings during restricted hours. You can request the CCTV footage as part of your appeal.'
      },
      {
        question: 'How much is a school parking fine?',
        answer: 'School keep clear contraventions are usually classified as higher-level offences: £70 outside London (reduced to £35 if paid within 14 days) or £130 in London (reduced to £65 if paid within 14 days). The higher classification reflects the safety concern.'
      },
      {
        question: 'What if the school zig-zag markings are faded?',
        answer: 'If the markings are significantly faded or incomplete, they may not comply with the Traffic Signs Regulations and General Directions 2016. Photograph the markings and include this evidence in your appeal. If the markings are not to the required standard, the restriction is not properly indicated and enforcement may be unlawful.'
      }
    ],
    relatedGuides: [
      'how-to-appeal-council-parking-fine',
    ...
    seoTitle: 'Parking Fine at School Pickup | Zig-Zag Lines & CCTV (2026)',
    seoDescription: 'Appeal a school run parking fine. Covers zig-zag line rules, CCTV enforcement, valid defences, TRO requirements, and how to challenge council PCNs near schools.'
  },
  {
    slug: 'parking-fine-nhs-worker',
    title: 'Parking Fine for NHS Workers',
    description: 'NHS worker got a parking fine at the hospital? Learn about NHS Trust parking policies, appeal grounds for healthcare staff, and how to challenge unfair charges.',
    category: 'situation',
    content: `## Parking Fine for NHS Workers
...
Got a parking fine at your hospital? [Use our free appeal tool](/appeal) to build a strong case based on your specific circumstances.`,
    faqs: [
      {
        question: 'Do NHS staff get free parking?',
        answer: 'This varies by NHS Trust. Government guidance recommends free parking for night shift workers and disabled staff. Some trusts offer free parking for all staff, while others charge for parking with means-tested discounts. Check your Trust parking policy or ask HR.'
      },
      {
        question: 'Can I appeal a hospital parking fine if my shift overran?',
        answer: 'Yes, shift overruns are a strong ground for appeal. Provide your rota, a statement from your line manager confirming the overrun, and any hospital records showing you were on duty. Most appeal bodies recognise that healthcare workers cannot leave patients to move their cars.'
      },
      {
        question: 'Should I contact my union about a hospital parking fine?',
        answer: 'Yes. RCN, BMA, Unison, and other NHS unions have extensive experience with hospital parking disputes. They can advise on your Trust parking policy, help draft your appeal, and in some cases intervene directly with the operator on your behalf.'
      },
      {
        question: 'What if the hospital car park was full when I arrived for my shift?',
        answer: 'Document that you arrived for a scheduled shift and there were no available spaces. If you had to park in a restricted area as a last resort, this supports your appeal. Include your rota or shift confirmation and, if possible, evidence that the car park is regularly full at that time (such as photos or statements from colleagues).'
      }
    ],
    relatedGuides: [
      'how-to-appeal-private-parking-fine',
    ...
    seoTitle: 'Parking Fine for NHS Workers | Hospital Staff Appeal Guide (2026)',
    seoDescription: 'NHS staff parking fine? Learn about Trust policies, shift overrun defences, permit issues, and how to appeal hospital parking charges as a healthcare worker.'
  },
  {
    slug: 'parking-fine-delivery-driver',
    title: 'Parking Fine for Delivery Drivers',
    description: 'Delivery driver got a parking fine? Learn about loading exemptions, evidence of active delivery, operator vs council enforcement, and how to appeal.',
    category: 'situation',
    content: `## Parking Fine for Delivery Drivers
...
Got a delivery parking fine? [Start your free appeal](/appeal) and we will help you build a case using the loading exemption.`,
    faqs: [
      {
        question: 'Can delivery drivers park on double yellow lines?',
        answer: 'Yes, for the purpose of active loading and unloading, provided there are no additional loading restriction signs (yellow kerb marks with times). The loading must be continuous and the goods must require use of a vehicle for transport. You cannot park and then leave the vehicle unattended.'
      },
      {
        question: 'How long can a delivery driver stop for loading?',
        answer: 'There is no fixed time limit for loading, but the activity must be continuous. For a typical parcel delivery, stopping for 5 to 10 minutes is generally reasonable. For larger items requiring multiple trips, longer stops are justified. The key is that loading must be the genuine reason for the stop and must be ongoing throughout.'
      },
      {
        question: 'Does my employer have to pay my parking fine?',
        answer: 'This depends on your employment contract and your employer parking policy. Some delivery companies pay fines incurred during legitimate deliveries. Others expect drivers to appeal and pay if the appeal fails. Check your contract and speak to your manager or union representative.'
      },
      {
        question: 'What if the CEO did not see me making a delivery?',
        answer: 'Request the civil enforcement officer pocket notebook entries. These should record what the officer observed and for how long. If the officer did not wait long enough to establish that loading was not taking place, or if you were briefly away from the vehicle during a delivery, this supports your appeal. The burden is on the council to prove you were not loading.'
      }
    ],
    relatedGuides: [
      'parking-fine-loading-unloading',
    ...
    seoTitle: 'Parking Fine for Delivery Drivers | Loading Exemption Guide (2026)',
    seoDescription: 'Delivery driver parking fine? Learn about loading exemptions, evidence requirements, council vs private enforcement, and who pays. Free appeal guide for delivery workers.'
  },
  {
    slug: 'parking-fine-clamped-car',
    title: 'Parking Fine and Wheel Clamping',
    description: 'Has your car been clamped? Learn about the ban on private clamping, what is still legal, your rights, and what to do if your vehicle is clamped unlawfully.',
    category: 'rights',
    content: `## Parking Fine and Wheel Clamping
...
1. **Do not pay the release fee.** The clamping is illegal, and paying does not legitimise it.
2. **Document everything.** Photograph the clamp, the vehicle, the location, any signage, and any notices left on the vehicle.
3. **Call the police.** Report the matter as a criminal offence under Section 54 of the Protection of Freedoms Act 2012. The police may attend and require the clamp to be removed.
4. **Note the details** of the clamping company: name, contact details, any company registration visible on their vehicles or uniforms.
5. **Do not remove the clamp yourself** unless you can do so without causing damage to the vehicle or the clamp. Damaging the clamp could lead to a counter-claim.
6. **Consider a civil claim.** If you suffered loss (missed work, taxi fares, distress), you may be able to claim compensation from the clamping company for the tort of trespass to goods.

### What If You Already Paid?

If you paid a release fee before realising the clamping was illegal, you can claim the money back:

1. Write to the clamping company demanding a refund, citing Section 54 of POFA 2012.
2. If they refuse, file a claim through the County Court (small claims track) for the return of the fee plus any consequential losses.
3. Report the company to Trading Standards and the police.
...
Has your car been clamped or blocked in on private land? [Use our free tool](/appeal) to understand your rights and get advice on next steps.`,
    faqs: [
      {
        question: 'Is wheel clamping on private land illegal?',
        answer: 'Yes. Since 1 October 2012, it has been a criminal offence under Section 54 of the Protection of Freedoms Act 2012 to clamp, tow, block in, or immobilise a vehicle on private land in England and Wales without lawful authority. This applies to all private land, including car parks, residential areas, and commercial property.'
      },
      {
        question: 'Can the council still clamp my car?',
        answer: 'Yes. The ban on clamping applies only to private land. Local authorities, the police, and the DVLA retain their powers to clamp vehicles on public roads in certain circumstances, such as persistent non-payment of PCNs (three or more unpaid charges) or driving an untaxed vehicle.'
      },
      {
        question: 'What should I do if someone threatens to clamp my car on private land?',
        answer: 'Inform them that clamping on private land is a criminal offence under POFA 2012. If they proceed, call the police. Document everything: photographs, witnesses, the company name, and any threats made. Do not pay any fees demanded in connection with clamping.'
      },
      {
        question: 'Can I get my money back if I already paid a release fee?',
        answer: 'Yes. If you paid a release fee for an illegal clamp on private land, you can demand a refund from the clamping company, citing POFA 2012. If they refuse, file a small claims court claim for the refund plus any consequential losses (such as taxi fares or lost earnings). Also report them to the police and Trading Standards.'
      }
    ],
    relatedGuides: [
      'pofa-2012-explained',
  ...
  },
  {
    ...
    title: 'Car Towed for Parking',
    description: 'Has your car been towed? Learn about council towing powers, release fees, how to challenge the removal, and getting your vehicle back.',
    category: 'rights',
    content: `## Car Towed for Parking
...
1. **A PCN must be issued** before or at the time of removal (not after).
2. **The removal must be authorised** by a civil enforcement officer or senior officer.
3. **A notice of removal** must be placed at the location where the vehicle was parked, or given to the driver if present.
4. **The vehicle must be taken to a designated pound**.
5. **The council must notify the registered keeper** within 24 hours of the removal.
...
1. **No valid PCN was issued**: If the PCN is invalid (for example, wrong contravention code, wrong vehicle details), the removal based on that PCN is also invalid.
2. **Removal was disproportionate**: If the vehicle was not causing a genuine obstruction or danger, the removal may have been disproportionate.
3. **Procedure not followed**: If the council did not follow the correct process (no notice left, no notification within 24 hours, no authorisation), the removal may be unlawful.
4. **The parking restriction was invalid**: If the underlying TRO or signage was defective, both the PCN and the removal can be challenged.

### Making a Claim

To challenge the removal and claim a refund of fees:

1. **Appeal the PCN** through the normal process (informal challenge, formal representation, tribunal).
2. **Separately challenge the removal** by writing to the council's parking department, setting out why the removal was unlawful.
3. **If the PCN is cancelled**, the removal loses its basis, and you are entitled to a refund of release and storage fees.
4. **If the council refuses to refund**, you can escalate to the tribunal or file a claim in the County Court.
...
Had your car towed? [Start your free appeal](/appeal) to check whether the PCN and removal were lawful, and find out if you are entitled to a refund.`,
    faqs: [
      {
        question: 'How much does it cost to get a towed car back?',
        answer: 'The release fee is typically £200, plus daily storage charges (usually £20 to £40 per day). You must also pay the PCN, though you can challenge the fine separately after retrieving your vehicle. Collect your car as soon as possible to minimise storage charges.'
      },
      {
        question: 'Can the council tow my car for a simple parking ticket?',
        answer: 'Not usually for a first offence in a non-obstructive location. Councils typically reserve towing for vehicles causing obstruction, parked dangerously, on red routes or clearways, or belonging to persistent evaders with multiple unpaid PCNs. A car parked slightly over a line that is not causing problems is unlikely to be towed.'
      },
      {
        question: 'Can a private parking company tow my car?',
        answer: 'No. Under Section 54 of the Protection of Freedoms Act 2012, it is illegal for private companies to tow vehicles from private land in England and Wales. If a private company tows your vehicle, call the police and document everything. You may be entitled to compensation.'
      },
      {
        question: 'Can I get a refund if the PCN is cancelled?',
        answer: 'Yes. If your PCN appeal is successful (either at the council stage or at tribunal), the basis for the removal is invalidated, and you are entitled to a full refund of the release fee and storage charges. Write to the council quoting the appeal decision and request the refund. If they refuse, escalate through the tribunal or County Court.'
      }
    ],
    relatedGuides: [
      'how-to-appeal-council-parking-fine',
      'parking-fine-clamped-car',
      'traffic-penalty-tribunal-guide',
      'what-happens-if-you-dont-pay-parking-fine'
    ],
    seoTitle: 'Car Towed for Parking | Release Fees, Rights & How to Challenge (2026)',
    seoDescription: 'Car towed by the council? Learn about release fees, storage charges, your rights, how to challenge the removal, and when you can claim a refund.'
  },
  {
    slug: 'parking-fine-motorbike',
    title: 'Parking Fine on a Motorbike',
    description: 'Got a parking fine on a motorcycle? Learn about ANPR issues, bay requirements, motorcycle-specific rules, and how to appeal.',
    category: 'situation',
    content: `## Parking Fine on a Motorbike
...
Received a parking fine on your motorbike? [Use our free appeal tool](/appeal) to check your grounds and generate a tailored response.`,
    faqs: [
      {
        question: 'Do motorcycles have to pay for parking?',
        answer: 'This depends on the specific location. Many councils provide free motorcycle bays on-street. In pay-and-display areas, motorcycles are usually required to pay unless the local rules exempt them. In private car parks, the terms on the signage apply to all vehicles including motorcycles.'
      },
      {
        question: 'Can ANPR cameras read motorcycle plates?',
        answer: 'ANPR cameras can struggle with motorcycle plates due to their smaller size, rear-only position, and different angle. Misreads are more common for motorcycles than for cars. If you have received a charge based on ANPR, request the images and check whether your plate was correctly captured.'
      },
      {
        question: 'Can I park my motorbike on the pavement?',
        answer: 'This varies by council. Some councils permit motorcycle pavement parking in designated areas or under specific conditions. Others prohibit it entirely. In London, Westminster and some other boroughs have designated on-pavement motorcycle bays. Check the local rules before parking on the pavement.'
      },
      {
        question: 'What if there is no way to display a parking ticket on my motorbike?',
        answer: 'If the parking system requires a physical ticket to be displayed and there is no practical way to attach it to a motorcycle (no windscreen, no secure location), you may have a defence. Photograph the situation and use electronic payment if available as an alternative. In your appeal, explain the practical impossibility of ticket display.'
      }
    ],
    relatedGuides: [
      'anpr-parking-fine-errors',
    ...
    seoTitle: 'Parking Fine on a Motorbike | ANPR Issues & Motorcycle Rules (2026)',
    seoDescription: 'Challenge a parking fine on a motorcycle. Covers ANPR misread defences, motorcycle bay rules, ticket display issues, and how to appeal as a motorbike rider.'
  },
  {
    slug: 'parking-fine-campervan',
    title: 'Parking Fine on a Campervan or Motorhome',
    description: 'Got a parking fine on a campervan or motorhome? Learn about size restrictions, overnight parking rules, height barriers, and specific defences for larger vehicles.',
    category: 'situation',
    content: `## Parking Fine on a Campervan or Motorhome
...
Got a parking fine on your campervan or motorhome? [Start your free appeal](/appeal) to check your grounds and build a strong case.`,
    faqs: [
      {
        question: 'Is it legal to sleep in a campervan on a public road?',
        answer: 'There is no general UK law against sleeping in a vehicle parked legally on a public road. However, some councils have specific byelaws or TROs prohibiting overnight sleeping in vehicles in certain areas. Check local rules before settling for the night.'
      },
      {
        question: 'Can I get fined for taking up two parking bays with my motorhome?',
        answer: 'This depends on the terms displayed on the signage. Unless the signage specifically states that vehicles must fit within a single bay or imposes a surcharge for larger vehicles, there is no clear basis for fining you for the space your vehicle occupies. Challenge any such charge on the grounds that the terms did not address vehicle size.'
      },
      {
        question: 'What if the height barrier was too low for my campervan?',
        answer: 'A height barrier is a physical restriction, not a parking contravention. If you could not enter because the barrier was too low, you cannot have parked inside. If the barrier was raised or absent but signage stated a height limit, check whether the signage was adequate. If there was no signage or the signage was unclear, you have grounds for appeal.'
      },
      {
        question: 'Can the council ban campervans from parking on the street?',
        answer: 'Councils can impose restrictions on specific vehicles through Traffic Regulation Orders, but a blanket ban on campervans across an entire area is unusual. Any restriction must be properly signed and backed by a valid TRO. If you have been fined under such a restriction, request the TRO and check whether it specifically covers your vehicle type.'
      }
    ],
    relatedGuides: [
      'parking-fine-signage-rules',
    ...
    seoTitle: 'Parking Fine on a Campervan or Motorhome | Size & Overnight Rules (2026)',
    seoDescription: 'Challenge a parking fine on a campervan or motorhome. Covers height restrictions, overnight parking rules, bay size disputes, and defences for larger vehicles.'
  }
];
